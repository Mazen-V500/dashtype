window.TypingGame = (() => {
    ...
    const textMap = {
        ar: {
            ...
            greeting: "تمرين سريع على كلمة واحدة لقياس السرعة والدقة.",
            startRound: "بدء جولة",
            ...
            modeTripleSeq: "نمط 3 كلمات متتابعة",
        ...
        en: {
            pageTitle: "DashType - Single Word Mode",
            gameTitle: "DashType - Single Word Mode",
            greeting: "Quick single-word drill to measure speed and accuracy.",
            ...
            resultStart: "Start the round now",
            ...
            modeTripleSeq: "Sequential 3 Words Mode",
