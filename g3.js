window.TypingGame = (() => {
    ...
    const textMap = {
        ar: {
            pageTitle: "DashType - نمط 7 كلمات متتالية",
            gameTitle: "DashType - نمط 7 كلمات متتالية",
            greeting: "سبع كلمات متتابعة كلمة بكلمة مع توقيت مستمر.",
            startRound: "بدء جولة",
            ...
            progressTriple: "النمط الحالي: {count} كلمات",
            progressTripleSeq: "الكلمة {index} من {count}",
        ...
        en: {
            pageTitle: "DashType - Sequential 7 Words",
            gameTitle: "DashType - Sequential 7 Words",
            greeting: "Sequential 7-word run, one word at a time with continuous timing.",
            ...
            progressTriple: "Current Mode: {count} Words",
            progressTripleSeq: "Word {index} of {count}",
