...
window.TypingGame = (() => {
    ...
    const textMap = {
        ar: {
            ...
            modeIdentityTitle: "النمط المتتابع",
            modeIdentityHint: "إيقاع متصل دون انقطاع",
            typingPlaceholder: "اكتب هنا...",
            timerLabel: "الوقت:",
            timerUnit: "ث",
            progressSingle: "الفردي",
            progressTriple: "الثلاثي ({count} كلمات)",
            progressTripleSeq: "المتتابع: الكلمة {index} من {count}",
        ...
        en: {
            ...
            modeIdentityTitle: "Sequential Mode",
            modeIdentityHint: "Continuous rhythm focus",
            typingPlaceholder: "Type here...",
            timerLabel: "Time:",
            timerUnit: "s",
            progressSingle: "Single",
            progressTriple: "Triple ({count} words)",
            progressTripleSeq: "Sequential: Word {index} of {count}",
    ...
    function initGamePage(config) {
        ...
        function getActiveRoundCharCount() {
            const source = mode === "triple-seq" && sequentialWords.length
                ? sequentialWords.join(" ")
                : currentWord;
            return normalizeInput(source).replace(/\s+/g, " ").length;
        }
